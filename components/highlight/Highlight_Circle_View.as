package components.highlight 
{
	 ...
	 * @author Dean Biele
	 */
	public class Highlight_Circle_View extends UIComponent 
	{
		...
		private var _highlightMC:Highlight_Circle_Asset_View;
		...
		public function Highlight_Circle_View() 
		{
			super();
		...
		public function initialize(checkRest:Boolean = false):void 
		{
			if (checkRest && _highlightMC != null) {
				...
				_highlightMC = new Highlight_Circle_Asset_View;
