package components.views 
{
	 ...
	 * @author Dean Biele
	 */
	public class CDRegister extends MovieClip 
	{
		...
		public var stationid_tfield:TextField;
		public var companyname_tfield:TextField;
		...
		private function onSubmitHandler(e:MouseEvent):void {
			_currentView.addUser(fname_tfield.text, lname_tfield.text, companyid_tfield.text, unitedid_tfield.text, stationid_tfield.text, companyname_tfield.text);
		}
